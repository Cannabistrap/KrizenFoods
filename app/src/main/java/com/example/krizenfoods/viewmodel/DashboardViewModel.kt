...
////    }
//
//    // Replace your markAllNotificationsAsRead() function in DashboardViewModel.kt with this:
//
//    fun markAllNotificationsAsRead() {
//        if (userId.isEmpty()) {
//            Log.e("DashboardVM", "❌ userId is empty!")
...
//        Log.d("DashboardVM", "🔵 UserId: $userId")
//
//        // ✅ GUARANTEED FIX - Update each notification individually
//        unreadList.forEach { notification ->
...
//                .child("isRead")
//
//            Log.d("DashboardVM", "→ Updating: ${notification.notificationId}")
//            Log.d("DashboardVM", "→ Path: notifications/$userId/${notification.notificationId}/isRead")
//
//            notifRef.setValue(true)
//                .addOnSuccessListener {
//                    Log.d("DashboardVM", "✅ Updated: ${notification.notificationId}")
//                }
//                .addOnFailureListener { e ->
//                    Log.e("DashboardVM", "❌ Failed ${notification.notificationId}: ${e.message}")
//                }
...
//        userEmail = ""
//        userId = ""
//        isAdmin = false  // ✅ IMPORTANT: Reset admin status
//        allFoods = emptyList()
...
//    }
//
//    // 🔔 NOTIFICATION FUNCTIONS - ✅ SUPER DEBUG VERSION
//
//    private fun loadNotifications() {
//        if (userId.isEmpty()) return
//
...
//        notificationsListener = object : ValueEventListener {
//            override fun onDataChange(snapshot: DataSnapshot) {
//                // ✅ Skip if we're manually updating
//                if (isUpdatingNotifications) {
//                    Log.d("DashboardVM", "⏸️ Skipping listener update (manual update in progress)")
//                    return
//                }
//
//                Log.d("DashboardVM", "🔄 Firebase listener triggered")
//
//                val notifs = mutableListOf<Notification>()
//                for (notifSnapshot in snapshot.children) {
//                    val notification = notifSnapshot.getValue(Notification::class.java)
//                    if (notification != null) {
//                        notifs.add(notification)
//                        Log.d("DashboardVM", "  → ${notification.notificationId.takeLast(5)}: read=${notification.read}")
//                    }
//                }
//
//                notifications = notifs.sortedByDescending { it.timestamp }
//
//                Log.d("DashboardVM", "📨 Total: ${notifs.size} | Unread: ${notifications.count { !it.read }}")
//            }
//
//            override fun onCancelled(error: DatabaseError) {
//                Log.e("DashboardVM", "❌ Error loading notifications: ${error.message}")
...
//        if (userId.isEmpty() || notificationId.isEmpty()) return
//
//        Log.d("DashboardVM", "🔘 Marking single notification as read: ${notificationId.takeLast(5)}")
//
//        // ✅ Update local state immediately
//        notifications = notifications.map { notif ->
...
//    }
//
//    // ✅ ULTIMATE FIX: Mark ALL with extensive logging
//    fun markAllNotificationsAsRead() {
//        if (userId.isEmpty()) {
//            Log.e("DashboardVM", "❌ userId is empty!")
//            return
//        }
//
//        val unreadList = notifications.filter { !it.read }
//
//        if (unreadList.isEmpty()) {
//            Log.d("DashboardVM", "ℹ️ No unread notifications")
//            return
...
//
//        Log.d("DashboardVM", "========================================")
//        Log.d("DashboardVM", "🔵 MARKING ALL AS READ")
//        Log.d("DashboardVM", "📊 Unread before: ${unreadList.size}")
//
//        unreadList.forEach {
//            Log.d("DashboardVM", "  → Will mark: ${it.notificationId.takeLast(5)}")
//        }
//
//        // ✅ STEP 1: Update local state IMMEDIATELY
//        notifications = notifications.map { it.copy(read = true) }
//        Log.d("DashboardVM", "✅ Local updated | Unread now: $unreadNotificationCount")
//
//        // ✅ STEP 2: Block listener
//        isUpdatingNotifications = true
//        Log.d("DashboardVM", "🔒 Listener BLOCKED")
//
...
//                val updates = mutableMapOf<String, Any>()
//                unreadList.forEach { notification ->
//                    val path = "notifications/$userId/${notification.notificationId}/read"
//                    updates[path] = true
//                    Log.d("DashboardVM", "  → Queued: $path")
//                }
//
//                Log.d("DashboardVM", "🔄 Sending ${updates.size} updates to Firebase...")
//
//                database.updateChildren(updates)
//                    .addOnSuccessListener {
//                        Log.d("DashboardVM", "✅ Firebase SUCCESS!")
//
//                        // Re-enable listener after delay
//                        viewModelScope.launch {
//                            delay(1500)
//                            isUpdatingNotifications = false
//                            Log.d("DashboardVM", "🔓 Listener UNBLOCKED")
//                            Log.d("DashboardVM", "========================================")
//                        }
//                    }
//                    .addOnFailureListener { e ->
//                        Log.e("DashboardVM", "❌ Firebase FAILED: ${e.message}")
//                        isUpdatingNotifications = false
//                        Log.d("DashboardVM", "========================================")
//                    }
//            } catch (e: Exception) {
//                Log.e("DashboardVM", "❌ Exception: ${e.message}")
//                isUpdatingNotifications = false
//                Log.d("DashboardVM", "========================================")
//            }
//        }
